...
Optimized version with better error handling and progress tracking.
"""
...
def scrape_product_page(product_url: str) -> Optional[Dict]:
    ...
    try:
        ...
        # Extract product data from JavaScript var item
                    ...
                    if match:
                        try:
                            ...
                            if 'price' in item_data:
                                product_data['price'] = str(item_data['price'])
...
def main():
    ...
    print("=" * 60)
    print("Starting to scrape faraline.ru product catalog")
    print("=" * 60)
    ...
    print(f"  - Data saved to: knowledge_base.json")
    print("=" * 60)
